...
ai_buffer g_wine_quality_data_map_activations[AI_WINE_QUALITY_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    1152, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_wine_quality_data_map_weights[AI_WINE_QUALITY_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    94364, NULL, s_wine_quality_weights_array_u64),   /* weights_array */
  };
...
ai_buffer ai_wine_quality_data_activations_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_WINE_QUALITY_DATA_ACTIVATIONS_SIZE, 1, AI_WINE_QUALITY_DATA_ACTIVATIONS_COUNT),
    AI_WINE_QUALITY_DATA_ACTIVATIONS_SIZE,
    NULL, ptr);
  return buf;
}
...
ai_buffer ai_wine_quality_data_weights_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_WINE_QUALITY_DATA_WEIGHTS_SIZE, 1, AI_WINE_QUALITY_DATA_WEIGHTS_COUNT),
    AI_WINE_QUALITY_DATA_WEIGHTS_SIZE,
    NULL, ptr);
  return buf;
}
...
{
  return AI_HANDLE_PTR(g_wine_quality_weights_table);

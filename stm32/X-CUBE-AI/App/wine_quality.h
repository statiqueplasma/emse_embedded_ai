...
#ifndef AI_WINE_QUALITY_H
#define AI_WINE_QUALITY_H
#pragma once
...
#define AI_WINE_QUALITY_INPUTS_IN_ACTIVATIONS   (4)
#define AI_WINE_QUALITY_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_WINE_QUALITY_IN_NUM        (1)

AI_DEPRECATED
#define AI_WINE_QUALITY_IN \
  ai_wine_quality_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_WINE_QUALITY_IN_SIZE { \
  AI_WINE_QUALITY_IN_1_SIZE, \
}
#define AI_WINE_QUALITY_IN_SIZE_BYTES { \
...
AI_DEPRECATED
#define AI_WINE_QUALITY_OUT \
  ai_wine_quality_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_WINE_QUALITY_OUT_SIZE { \
  AI_WINE_QUALITY_OUT_1_SIZE, \
}
#define AI_WINE_QUALITY_OUT_SIZE_BYTES { \
  AI_WINE_QUALITY_OUT_1_SIZE_BYTES, \
}
#define AI_WINE_QUALITY_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_WINE_QUALITY_OUT_1_CHANNEL     (7)
#define AI_WINE_QUALITY_OUT_1_SIZE        (7)
#define AI_WINE_QUALITY_OUT_1_SIZE_BYTES  (28)

/******************************************************************************/
#define AI_WINE_QUALITY_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup wine_quality
 ...
 * @ref ai_wine_quality_create. Both the activations memory buffer 
 ...
 * using @ref ai_wine_quality_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_wine_quality_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_wine_quality_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_WINE_QUALITY_*
 * defines into file @ref wine_quality.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wine_quality_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_WINE_QUALITY_H */
